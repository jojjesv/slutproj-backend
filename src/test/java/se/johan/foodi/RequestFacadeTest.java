 ...
 * Dummy test class (Got heavily stuck on EJBContainer exception "no provider names found")
...
public class RequestFacadeTest {
  ...
  public static void setUpClass() {
    try {
      ...
      props.put(EJBContainer.MODULES, new File("/home/johan/NetBeansProjects/SlutProjektBackend/target/classes"));
      props.put(EJBContainer.PROVIDER, "org.glassfish.ejb.embedded.EJBContainerProviderImpl");
      props.put(EJBContainer.APP_NAME, "SlutProjektBackend");
